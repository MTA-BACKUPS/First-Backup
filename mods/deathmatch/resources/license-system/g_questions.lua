...
questions = { 
	...
	{"Which side of the street should you drive on?", "Left", "Right (x)", "Either", 2},
	{"At an intersection with a four-way stop, which driver can go first?", "The driver to the left of you.", "The driver to the right of you. (x)", "Who ever reached the intersection first.", 2}, 
	{"What would be a reason for approaching a sharp curve slowly?", "To save wear and tear on your tires.", "To be able to take in the scenery.", "To be able to stop if someone is in the roadway. (x)", 3},
	{"When a traffic light is red you should...", "Bring the vehicle to a complete stop. (x)", "Continue.", "Continue if nothing is coming.", 1},
	{"Drivers must yield to pedestrians:", "At all times. (x)", "On private property.", "Only in a crosswalk. ", 1},
	{"The blind spots where trucks will not be able to see you are:", "Directly behind the body.", "The immediate left of the cab.", "All of the above. (x)" , 3},
	{"There is an emergency vehicle coming from behind you with emergency lights on and flashing. You should:", "Slow down and keep moving.", "Pull over to the right and stop. (x)", "Maintain your speed. ", 2},
	{"On a road with two or more lanes traveling in the same direction, the driver should:", "Drive in any lane.", "Drive in the left lane.", "Drive in the right lane except to pass. (x)", 3},
	{"In bad weather, you should make your car easier for others to see by:", "Turning on your headlights. (x)", "Turning on your emergency flashers.", "Flash your high beams.", 1},
	{"You may not park within how many feet of a fire hydrant?", "10 feet", "15 feet (x)", "20 feet", 2}
}